CREATE TABLE IF NOT EXISTS lines (
  ...
  webhook_by_event BOOLEAN NOT NULL DEFAULT FALSE,
  webhook_events TEXT,
...
CREATE TABLE IF NOT EXISTS line_webhook_events (
  line_id INTEGER NOT NULL,
  event TEXT NOT NULL,
  PRIMARY KEY (line_id, event),
  CONSTRAINT fk_line_events_line FOREIGN KEY (line_id) REFERENCES lines (id) ON DELETE CASCADE
);
...
ALTER TABLE lines ADD COLUMN IF NOT EXISTS webhook_by_event BOOLEAN;
ALTER TABLE lines ADD COLUMN IF NOT EXISTS webhook_events TEXT;
...
ALTER TABLE lines ADD COLUMN IF NOT EXISTS reject_calls BOOLEAN;
ALTER TABLE lines ADD COLUMN IF NOT EXISTS read_messages BOOLEAN;
ALTER TABLE lines ADD COLUMN IF NOT EXISTS read_status BOOLEAN;
ALTER TABLE lines ADD COLUMN IF NOT EXISTS sync_history BOOLEAN;
ALTER TABLE lines ADD COLUMN IF NOT EXISTS always_online BOOLEAN;
